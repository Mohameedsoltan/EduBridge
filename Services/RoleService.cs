    ...
    UserManager<ApplicationUser> userManager) : IRoleService
{
        ...
        CreateRoleRequest request, CancellationToken cancellationToken = default)
    {
        ...
        return result.Succeeded
            ? Result.Success()
            : Result.Failure(new Error("Role.CreateFailed", result.Errors.First().Description, StatusCodes.Status400BadRequest));
    }
        ...
        string roleId, UpdateRoleRequest request, CancellationToken cancellationToken = default)
    {
        ...
        return result.Succeeded
            ? Result.Success()
            : Result.Failure(new Error("Role.UpdateFailed", result.Errors.First().Description, StatusCodes.Status400BadRequest));
    }
        ...
        string roleId, CancellationToken cancellationToken = default)
    {
        ...
        return result.Succeeded
            ? Result.Success()
            : Result.Failure(new Error("Role.DeleteFailed", result.Errors.First().Description, StatusCodes.Status400BadRequest));
    }
        ...
        AssignRoleRequest request, CancellationToken cancellationToken = default)
    {
        ...
        return result.Succeeded
            ? Result.Success()
            : Result.Failure(new Error("Role.AssignFailed", result.Errors.First().Description, StatusCodes.Status400BadRequest));
    }
        ...
        AssignRoleRequest request, CancellationToken cancellationToken = default)
    {
        ...
        return result.Succeeded
            ? Result.Success()
            : Result.Failure(new Error("Role.RemoveFailed", result.Errors.First().Description, StatusCodes.Status400BadRequest));
    }
}