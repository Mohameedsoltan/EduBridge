...
{
    // Queries
    Task<Result<IEnumerable<JoinRequestResponse>>> GetIncomingRequestsAsync(Guid teamId, CancellationToken cancellationToken = default);
    Task<Result<IEnumerable<JoinRequestResponse>>> GetUserRequestsAsync(string studentId, CancellationToken cancellationToken = default);
